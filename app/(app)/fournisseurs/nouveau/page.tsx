...
const fields = [
  { key: 'nom', label: 'Nom / Raison sociale', labelAr: 'الاسم', required: true, placeholder: 'Fournisseur SARL' },
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground text-sm" dir="rtl">مورد جديد</p>
      </div>
